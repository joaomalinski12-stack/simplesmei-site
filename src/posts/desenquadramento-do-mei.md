---
title: "Desenquadramento do MEI: causas e como evitar"
date: "2026-06-22"
...
faq:
  - q: "O que é o desenquadramento do MEI?"
    a: "É a saída do regime do MEI. A empresa deixa de ser Microempreendedor Individual e passa a ser Microempresa (ME) no Simples Nacional, com mais impostos e obrigações. Pode ser voluntário ou feito de ofício pela Receita."
  - q: "Quanto posso faturar acima do teto do MEI sem retroagir?"
    a: "Se você faturar até 20% acima do teto (até R$ 97.200), o desenquadramento vale a partir de 1º de janeiro do ano seguinte. Se passar de 20%, retroage a janeiro do próprio ano e os tributos são recolhidos como ME."
  - q: "O que faz o MEI ser desenquadrado?"
    a: "Estourar o teto de R$ 81.000 por ano, contratar mais de um funcionário, abrir uma segunda empresa ou virar sócio/titular de outra, ou exercer atividade que não é permitida ao MEI."
  - q: "O que muda quando o MEI vira ME?"
    a: "Sai do DAS fixo e passa a recolher por percentual do faturamento, conforme a tabela do Simples Nacional. Surgem obrigações acessórias e, na prática, a contabilidade passa a ser necessária."
  - q: "Como evito o desenquadramento por estourar o teto?"
    a: "Acompanhe o faturamento acumulado do ano em tempo real e desacelere ou planeje a migração antes de chegar perto dos R$ 81.000. Vigiar o teto a cada nota é a forma mais segura de não ser pego de surpresa."
  - q: "Desenquadramento voluntário e de ofício são a mesma coisa?"
    a: "Não. O voluntário é quando você mesmo pede a saída pelo Portal do Empreendedor. O de ofício é quando a Receita identifica a irregularidade e desenquadra você, geralmente com efeito retroativo e cobrança de diferenças."
---
...
> Aqui mora o calcanhar de Aquiles: você raramente percebe o teto chegando, porque ele é anual e o faturamento entra aos poucos. Entender bem [o limite do MEI](/blog/limite-do-mei) e somar cada nota ao acumulado do ano é o que separa quem desenquadra de quem fica tranquilo.
...
Nem toda profissão pode ser MEI. As ocupações permitidas estão numa lista oficial (o Anexo da Resolução do CGSN). Se você passa a exercer uma atividade que está fora dessa lista, o enquadramento cai. Por isso a escolha do código de atividade importa tanto — vale entender [o CNAE do MEI](/blog/cnae-do-mei) antes de mudar de ramo ou incluir um serviço novo.
...
Vigiar o teto em tempo real é a forma mais segura de nunca ser pego de surpresa. E se você ainda nem formalizou o negócio, vale começar entendendo [como abrir o MEI](/blog/como-abrir-mei) do jeito certo — escolhendo a atividade e o regime que combinam com onde você quer chegar.
