...
coverPalette: "coral"
faq:
  - q: "O microempreendedor individual precisa emitir nota fiscal eletronica?"
    a: "Para vender ou prestar serviço a outra empresa (pessoa jurídica), sim, sempre. Para pessoa física, só é obrigado quando o cliente pede a nota."
  ...
  - q: "Emitir NFS-e é pago?"
    a: "Não. A emissão pelo sistema da sua prefeitura ou pelo Emissor Nacional (gov.br/nfse) é gratuita. Pode haver custo de certificado digital em alguns sistemas municipais."
  - q: "A nota fiscal do MEI conta para o teto?"
    a: "Sim. O valor de cada nota soma no seu faturamento anual, que tem teto de R$ 81 mil. Por isso vale acompanhar quanto já saiu antes de emitir."
---
...
A lição prática: **não emita no escuro**. Antes de mandar uma nota grande no fim do ano, vale saber quanto já saiu. Se quiser entender a régua inteira, veja o [limite do MEI em 2026](/blog/limite-do-mei) e o que é o [desenquadramento do MEI](/blog/desenquadramento-do-mei).
...
O passo a passo detalhado de cada caminho está no irmão deste post, [como emitir nota fiscal como MEI](/blog/como-emitir-nota-fiscal-mei). E se a sua praia é resolver pelo celular, sem entrar em portal nenhum, veja como [emitir a nota pelo WhatsApp](/blog/nota-fiscal-pelo-whatsapp) — inclusive deixar a nota fixa do mesmo cliente sair sozinha todo mês, no recurso de [nota fiscal recorrente](/blog/nota-fiscal-recorrente-mei).

Resumindo o que segura tudo: a nota do MEI de serviço é a **NFS-e**; você emite **sempre** para empresa e **sob pedido** para pessoa física; e cada nota **soma no teto** de R$ 81 mil. Com isso na cabeça, o resto é só apertar o botão certo. Se você ainda nem tem CNPJ, comece por [como abrir o MEI](/blog/como-abrir-mei) — é grátis e sai na hora.
