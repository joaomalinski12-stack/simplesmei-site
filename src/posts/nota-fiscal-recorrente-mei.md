---
title: "Nota fiscal recorrente: como deixar a emissão no automático"
date: "2026-06-25"
...
faq:
  - q: "O que é nota fiscal recorrente?"
    a: "É a nota que se repete todo mês para o mesmo cliente, com o mesmo serviço e valor — típica de mensalidade ou contrato. Em vez de emitir do zero toda vez, você configura uma vez e a nota volta a sair no ciclo."
  - q: "MEI com cliente fixo precisa emitir nota todo mês?"
    a: "Quando o tomador é pessoa jurídica, o MEI é obrigado a emitir a nota; para pessoa física é opcional, mas emitir mantém o faturamento e o controle do teto em dia. Se o serviço é prestado todo mês, o ideal é emitir a cada competência."
  - q: "Dá para deixar a nota fiscal no automático?"
    a: "Dá para chegar perto. No SimplesMEI você configura a recorrência uma vez pelo WhatsApp e a nota volta a sair no ciclo, sem refazer tudo. É bem mais perto do automático do que emitir manualmente no portal todo mês."
  - q: "Esquecer de emitir a nota recorrente dá problema?"
    a: "Pode dar. Notas atrasadas ou esquecidas bagunçam o seu faturamento, atrapalham o controle do teto de R$ 81 mil por ano e podem deixar o cliente PJ sem o comprovante que ele precisa. A recorrência existe justamente para você não esquecer."
  - q: "A nota recorrente conta para o teto do MEI?"
    a: "Conta. Toda nota emitida soma no seu faturamento anual. Por isso a recorrência ajuda no controle do teto: cada emissão entra na conta e o SimplesMEI projeta o impacto antes de bater no limite."
  - q: "Posso mudar o valor de uma nota recorrente?"
...
Se você ainda emite tudo na mão, vale primeiro entender [como emitir nota fiscal como MEI](/blog/como-emitir-nota-fiscal-mei) do começo ao fim — a recorrência é o passo seguinte, depois que a emissão avulsa já está dominada.
...
Esse controle é tão importante que tem post inteiro só sobre isso: vale ler sobre o [controle do teto](/blog/limite-do-mei) para entender o que acontece se você estourar (tolerância de até 20%, desenquadramento e cobrança retroativa).
...
Se a sua carteira de clientes fixos está crescendo e o faturamento subindo, entender o [controle do teto](/blog/limite-do-mei) e a tolerância de 20% deixa de ser opcional: é o que separa o crescimento saudável do desenquadramento retroativo.
...
Se você ainda está dando os primeiros passos, comece por [como abrir o MEI](/blog/como-abrir-mei) e por dominar a emissão avulsa. A recorrência é o upgrade natural quando os clientes fixos aparecem.
