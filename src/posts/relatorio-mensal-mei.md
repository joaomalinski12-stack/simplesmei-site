---
title: "Relatório mensal do MEI: como fazer, prazo e modelo"
date: "2026-07-01"
...
faq:
  - q: "O relatório mensal do MEI é obrigatório?"
    a: "Sim. O Relatório Mensal de Receitas Brutas é uma obrigação prevista em lei desde a formalização. Você preenche até o dia 20 do mês seguinte às vendas ou serviços e arquiva o documento — não precisa entregar a nenhum órgão."
  - q: "Preciso entregar o relatório mensal para a Receita?"
    a: "Não. O relatório não é enviado a nenhum órgão. Ele é preenchido e guardado junto com as notas fiscais de compra e de venda, por no mínimo 5 anos, para o caso de fiscalização."
  - q: "Qual o prazo do relatório mensal do MEI?"
    a: "Até o dia 20 do mês seguinte ao das vendas ou serviços. O relatório de janeiro, por exemplo, é preenchido até 20 de fevereiro. É um registro mensal, diferente da DASN, que é anual."
  - q: "O que deve constar no relatório mensal?"
    a: "A receita bruta do mês, separada entre comércio/indústria e serviços, incluindo o que teve nota e o que não teve. Ao relatório você anexa as notas fiscais de compras e das vendas do período."
  - q: "Qual a relação entre o relatório mensal e a DASN?"
    a: "O relatório mensal é a base da DASN. Somando os 12 relatórios do ano, você tem o faturamento bruto que declara na DASN-SIMEI. Manter o relatório em dia deixa a declaração anual trivial."
---
...
Sim, o relatório mensal é **obrigatório para todo MEI**, desde a formalização. Não importa se você faturou muito, pouco ou **nada** naquele mês — a obrigação de preencher (nem que seja com **R$ 0,00**) existe. É uma das [obrigações do MEI](/blog/obrigacoes-do-mei) que passam quase despercebidas, justamente porque o documento fica com você.
...
Na prática, vale casar as duas tarefas do dia 20: ao gerar/pagar [o DAS do mês](/blog/das-do-mei), aproveite para **fechar o relatório** daquele período. Duas obrigações resolvidas de uma vez, com o número fresco na cabeça.
...
| Campo do relatório | O que preencher |
| --- | --- |
| Receita de comércio e indústria — **com** nota fiscal | Soma das vendas de produto com nota no mês |
| Receita de comércio e indústria — **sem** nota fiscal | Vendas de produto sem nota (ex.: consumidor final) |
| Receita de serviços — **com** nota fiscal | Soma dos serviços prestados com NFS-e |
| Receita de serviços — **sem** nota fiscal | Serviços cobrados sem nota |
| **Total bruto do mês** | Soma de tudo acima |
...
| Obrigação | O que é | Frequência | Você entrega? |
| --- | --- | --- | --- |
| **Relatório mensal** | Registro do faturamento do mês | Mensal (até dia 20) | Não — arquiva 5 anos |
| **DAS** | Guia de pagamento dos tributos | Mensal (vence dia 20) | Paga (Pix/boleto) |
| **DASN-SIMEI** | Declaração anual do faturamento | Anual (até 31/05) | Sim — no Portal |

A conexão importante: o **relatório mensal alimenta a DASN**. Somando os **12 relatórios** do ano, você chega ao **faturamento bruto** que declara na [declaração anual (DASN-SIMEI)](/blog/declaracao-anual-mei). Quem mantém o relatório em dia não passa aperto em maio — o número já está pronto. E esse mesmo total é o que diz se você respeitou [o teto do MEI](/blog/limite-do-mei).
...
Para ver como tudo se encaixa, comece por [as obrigações do MEI](/blog/obrigacoes-do-mei), entenda [o DAS mensal](/blog/das-do-mei) que vence no mesmo dia 20 e veja como o relatório vira a base da [declaração anual (DASN-SIMEI)](/blog/declaracao-anual-mei). No fim, a regra é simples: **anote o faturamento, feche o relatório até o dia 20 e guarde por 5 anos** — e a sua vida fiscal de MEI fica em ordem sem susto.
