---
title: "Programador pode ser MEI? A resposta honesta"
date: "2026-07-01"
...
faq:
  - q: "Programador pode ser MEI?"
    a: "Em regra, não. As atividades de desenvolvimento de software, programação e análise de sistemas não estão na lista oficial de ocupações permitidas ao MEI. Um programador que quer emitir nota por esse serviço precisa de outra natureza jurídica."
  - q: "Por que programação não é permitida ao MEI?"
    a: "Porque a lista de ocupações do MEI é fechada (taxativa): só pode ser MEI quem exerce uma das atividades previstas em resolução. As atividades de tecnologia da informação e desenvolvimento de sistemas ficaram de fora dessa lista."
  - q: "Qual a alternativa para o programador se formalizar?"
    a: "Abrir uma empresa em outra natureza jurídica, como a Sociedade Limitada Unipessoal (SLU), enquadrada no Simples Nacional como Microempresa. Assim ele emite nota de serviço de TI legalmente, com um contador cuidando da parte fiscal."
  - q: "Existe algum CNAE de tecnologia permitido ao MEI?"
    a: "Há ocupações criativas e correlatas na lista, como editor de vídeo independente, mas desenvolvimento de software, programação e manutenção de sistemas em si não estão. Antes de abrir, confirme a atividade exata na lista oficial."
  - q: "E quem faz só um bico de programação?"
    a: "Mesmo o bico precisa do enquadramento certo. Como programar não é ocupação de MEI, não dá para forçar a abertura por outra atividade e emitir nota de programação. O caminho honesto é o enquadramento adequado para TI."
---
...
Não é uma questão de faturamento — é de **enquadramento da atividade**. Mesmo faturando pouco, o serviço de programação exige um CNAE que o MEI não comporta. Para entender como funciona essa lista, veja [as atividades permitidas ao MEI](/blog/atividades-permitidas-mei) e [o que é o CNAE do MEI](/blog/cnae-do-mei).
...
É mais burocrático e mais caro que o MEI, mas é o enquadramento que existe para a atividade. Se você já é MEI em outra ocupação e passou a programar, entenda também [o desenquadramento do MEI](/blog/desenquadramento-do-mei) e [a diferença entre MEI e ME](/blog/diferenca-mei-e-me).
...
Para quem faz atividades que **realmente** cabem no MEI, veja [o que é o MEI](/blog/o-que-e-mei) e [as atividades permitidas](/blog/atividades-permitidas-mei). E se o seu caso é programação, o próximo passo é procurar o enquadramento certo — não o MEI.
