---
title: "Como dar baixa no MEI: passo a passo para fechar o CNPJ"
date: "2026-06-25"
...
faq:
  - q: "Como dar baixa no MEI?"
    a: "Você faz a baixa pelo Portal do Empreendedor (gov.br), na opção de cancelamento do MEI, entrando com a sua conta gov.br. Em poucos passos o CNPJ é encerrado, sem custo e sem precisar de contador. Depois, você ainda precisa entregar a DASN de extinção."
  - q: "Dar baixa no MEI cancela os débitos de DAS em aberto?"
    a: "Não. Fechar o CNPJ não apaga o DAS atrasado. Os débitos continuam no seu CPF e podem ser inscritos na Dívida Ativa da União, com juros e multa. O ideal é quitar ou parcelar tudo antes de dar baixa."
  - q: "Preciso declarar alguma coisa ao dar baixa no MEI?"
    a: "Sim. Além do cancelamento, você entrega a DASN-SIMEI de extinção (declaração de situação especial), informando o faturamento do ano até o mês da baixa. É obrigatória e gratuita, feita no Portal do Empreendedor."
...
Neste guia direto você vê o **passo a passo** do cancelamento, o que fazer **antes** de dar baixa (quitar o DAS e declarar), o que acontece com **débitos pendentes**, como funciona a **DASN-SIMEI de extinção** e quando o certo é dar baixa em vez de [desenquadrar](/blog/desenquadramento-do-mei).
...
1. **Quite (ou parcele) o DAS em aberto.** O cancelamento não perdoa guias atrasadas. Pague os meses pendentes ou peça o parcelamento no Simples Nacional. Se tiver dúvida do que está em aberto, veja como [quitar o DAS antes](/blog/das-do-mei) e consulte os seus débitos no e-CAC da Receita.
...
1. **Acesse o Portal do Empreendedor.** Entre no [Portal do Empreendedor](https://www.gov.br/empresas-e-negocios/pt-br/empreendedor) (gov.br) e procure a opção **"Já sou MEI" → "Baixa do MEI"** (cancelamento).
...
Quem quer entender melhor como essa declaração funciona — e como ela difere do Imposto de Renda da pessoa física — pode ver o [guia da declaração anual (DASN-SIMEI)](/blog/declaracao-anual-mei).
...
| Critério | Dar baixa no MEI | Desenquadramento |
| --- | --- | --- |
| O que acontece com o CNPJ | É encerrado (empresa deixa de existir) | Continua ativo, vira ME no Simples Nacional |
| Quando usar | Você vai parar de empreender | O negócio cresceu (estourou o teto, contratou, etc.) |
| Obrigações depois | Acabam (após quitar pendências) | Continuam, agora como ME — com mais impostos |
| Custo | Gratuito | Gratuito (mas a ME passa a pagar mais tributos) |

Se o seu caso é o segundo — faturamento acima de **R$ 81.000 por ano**, contratação de mais de um funcionário ou mudança de atividade —, o caminho **não é a baixa**, é o desenquadramento. Entender a diferença entre [baixa x desenquadramento](/blog/desenquadramento-do-mei) evita o erro de fechar o CNPJ quando, na verdade, o negócio só precisava migrar de regime.
...
Se a sua dúvida não é fechar, mas migrar porque o negócio cresceu, comece por [baixa x desenquadramento](/blog/desenquadramento-do-mei). Para colocar a conta em dia antes da baixa, veja como [quitar o DAS antes](/blog/das-do-mei). E não esqueça o [guia da declaração anual (DASN-SIMEI)](/blog/declaracao-anual-mei) — é a declaração de extinção que fecha o ciclo de verdade. Dar baixa é o ponto final; só vale a pena dar quando o que veio antes já está resolvido.