---
title: "MEI pode receber Bolsa Família? Renda e regras"
date: "2026-07-01"
...
faq:
  - q: "MEI pode receber Bolsa Família?"
    a: "Pode. Virar MEI não corta o Bolsa Família automaticamente. O que vale é a renda por pessoa da família (renda per capita) no Cadastro Único: enquanto ela ficar dentro do limite do programa, o benefício segue."
  - q: "Qual a renda para continuar no Bolsa Família sendo MEI?"
    a: "O critério é a renda familiar por pessoa dentro da linha de pobreza (em torno de R$ 218 por pessoa, valor que o governo atualiza). Some a renda de todos e divida pelo número de pessoas da família. Confirme o valor vigente no gov.br."
  - q: "O que é a Regra de Proteção do Bolsa Família?"
    a: "É a regra que protege quem melhorou de renda, inclusive por virar MEI. A família pode continuar no programa por até 2 anos recebendo 50% do benefício, desde que a renda por pessoa fique até meio salário mínimo. Confirme o valor atual no gov.br."
  - q: "Preciso declarar a renda do MEI no CadÚnico?"
    a: "Sim. Ao atualizar o Cadastro Único, informe quanto você ganha como MEI. Omitir renda pode gerar bloqueio e devolução de valores. Manter o CadÚnico atualizado é o que garante o benefício na regra certa."
  - q: "Virar MEI vale a pena para quem recebe Bolsa Família?"
    a: "Costuma valer: você se formaliza, emite nota, ganha direitos do INSS e ainda tem a Regra de Proteção por até 2 anos se a renda subir. O próprio governo estimula essa transição. Avalie a sua renda por pessoa antes."
---
...
1. **Confira a sua renda por pessoa.** Some as rendas da família (com uma estimativa do que o MEI vai faturar) e divida pelo número de pessoas. Isso mostra em qual regra você cai.
2. **Abra o MEI de graça.** A formalização é gratuita no Portal do Empreendedor — veja [como abrir o MEI](/blog/como-abrir-mei). Se cobrarem, é golpe.
3. **Atualize o CadÚnico.** Vá ao **CRAS** (ou pelo canal oficial) e informe a nova renda. É o passo que ativa a regra correta, inclusive a Regra de Proteção, se for o caso.
4. **Acompanhe o benefício.** Com o cadastro certo, você sabe exatamente em que situação está e evita bloqueios.

## Como o SimplesMEI ajuda

O [**SimplesMEI**](/) é uma **IA que cuida do fiscal do MEI dentro do WhatsApp** — e, para quem sai do Bolsa Família rumo à formalização, ele tira o peso da **parte fiscal**: a IA ajuda a [abrir o MEI](/blog/como-abrir-mei) de graça, **emite as suas notas** por uma frase e lembra do **DAS**, para o seu negócio começar organizado desde o primeiro dia.
...
Para entender a base, comece por [o que é o MEI](/blog/o-que-e-mei) e o que você ganha ao se formalizar — inclusive a [aposentadoria e os benefícios do INSS](/blog/aposentadoria-mei) que vêm com o DAS. A mensagem central: **virar MEI não tira o seu Bolsa Família** — mantenha a renda por pessoa dentro da regra, atualize o CadÚnico e use a Regra de Proteção a seu favor.
