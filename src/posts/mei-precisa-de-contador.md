---
title: "MEI precisa de contador? O que diz a lei"
date: "2026-07-01"
...
faq:
  - q: "O MEI é obrigado a ter contador?"
    a: "Não. A Lei Complementar 123/2006 dispensa o MEI de contabilidade formal e de contratar contador. O MEI pode abrir o CNPJ, pagar o DAS, emitir nota e fazer a declaração anual por conta própria, sem custo com contabilidade."
  - q: "O que o MEI consegue fazer sozinho?"
    a: "Praticamente tudo do dia a dia: abrir e alterar o CNPJ no Portal do Empreendedor, gerar e pagar o DAS, emitir notas fiscais, entregar a DASN-SIMEI anual e guardar o relatório mensal de receitas. Nada disso exige contador."
  - q: "Quando vale a pena um contador para o MEI?"
    a: "Em situações específicas: dúvidas fiscais complexas, contratação de empregado com folha de pagamento, planejamento para virar Microempresa ou organização financeira. Aí um contador ajuda, mas segue sendo opcional, não obrigatório."
  - q: "O MEI precisa fazer contabilidade formal?"
    a: "Não. O MEI é dispensado de escrituração contábil formal (livro-diário, balanço). A única obrigação de controle é o Relatório Mensal de Receitas, preenchido pelo próprio MEI para registrar quanto faturou em cada mês."
  - q: "Contador é obrigatório para abrir o MEI?"
    a: "Não. A abertura do MEI é gratuita e feita pelo próprio empreendedor no portal gov.br/mei, sem intermediário. Despachante ou contador na abertura é opcional — e cobrar por isso é um serviço, não uma exigência da lei."
---
...
Nada disso depende de contador. Os guias de cada etapa estão em [como abrir o MEI](/blog/como-abrir-mei), [o DAS do MEI](/blog/das-do-mei), [como emitir nota fiscal](/blog/como-emitir-nota-fiscal-mei) e [a declaração anual](/blog/declaracao-anual-mei).
...
- **Planejar a migração para Microempresa** quando o negócio cresce (o [desenquadramento](/blog/desenquadramento-do-mei)).
...
O MEI é **dispensado de contabilidade formal**: não precisa manter livro-diário, balanço patrimonial nem escrituração contábil. A **única** obrigação de controle é o **Relatório Mensal de Receitas** — uma folha simples onde você anota quanto faturou em cada mês e anexa as notas. É isso que sustenta a sua [declaração anual](/blog/declaracao-anual-mei) e comprova que você respeitou o teto.

Ou seja: em vez de contabilidade completa, o MEI tem um **controle enxuto**, que ele mesmo mantém. Veja como no guia do [relatório mensal do MEI](/blog/relatorio-mensal-mei).
...
Para se aprofundar, veja [as obrigações do MEI](/blog/obrigacoes-do-mei), [a declaração anual](/blog/declaracao-anual-mei) e [MEI e Simples Nacional](/blog/mei-e-simples-nacional). A resposta curta: contador o MEI **não** precisa — o que precisa é manter o DAS, a nota e a declaração em dia.
