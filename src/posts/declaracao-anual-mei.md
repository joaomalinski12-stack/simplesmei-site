---
title: "Declaração anual do MEI (DASN-SIMEI): prazo e passos"
date: "2026-06-27"
...
faq:
  ...
  - q: "Preciso declarar se abri o MEI no ano passado?"
    a: "Sim. Quem abriu o MEI em qualquer mês do ano anterior precisa entregar a DASN do período em que esteve ativo, mesmo que tenha faturado pouco ou nada. Quem deu baixa também entrega a declaração de extinção."
---
...
Entre no [Portal do Empreendedor](https://www.gov.br/empresas-e-negocios/pt-br/empreendedor) (gov.br) e procure **"Já sou MEI" → "Declaração Anual de Faturamento (DASN-SIMEI)"**. O login é com a sua conta **gov.br**. Tenha o **CNPJ** do MEI em mãos.
...
O **faturamento bruto** é tudo o que o MEI recebeu pela atividade no ano, **independentemente de ter emitido nota**. Por isso vale acompanhar o número durante o ano, e não tentar lembrar tudo em maio. Esse total também é o que diz se você respeitou [o teto/faturamento](/blog/limite-do-mei) do MEI, hoje em **R$ 81.000 por ano** (fonte: Portal do Empreendedor, 2026). Estourar esse valor é a causa mais comum de [desenquadramento do MEI](/blog/desenquadramento-do-mei) — e a DASN é justamente onde a Receita enxerga isso.
...
- **Abriu o MEI no ano passado:** declare normalmente o que faturou desde a abertura. Faturou zero? Declare zero. Se ainda vai abrir, veja [como abrir o MEI](/blog/como-abrir-mei).
- **Deu baixa no CNPJ:** além da baixa, entregue a **DASN de extinção** dentro do prazo da situação especial. Sem ela, o encerramento fica pendente. Detalhes em [como dar baixa no MEI](/blog/como-dar-baixa-no-mei).
...
O que mais pesa na DASN é saber **quanto você faturou no ano** — e é aí que a IA trabalha o ano inteiro: ela **emite a sua nota** com uma frase, **guarda o histórico** e fica de olho no quanto você já acumulou, para você não estourar [o teto/faturamento](/blog/limite-do-mei) nem chegar em maio sem o número na mão. Tudo isso anda junto com [o DAS mensal](/blog/das-do-mei) e com [as obrigações do MEI](/blog/obrigacoes-do-mei), que reúnem o calendário fiscal completo da categoria.
