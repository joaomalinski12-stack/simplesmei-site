---
title: "CNAE MEI: o que é, como escolher e consultar o seu"
date: "2026-06-20"
...
faq:
  - q: "O que é o CNAE do MEI?"
    a: "CNAE é o código que classifica a atividade econômica da sua empresa. Para o MEI, ele nasce da ocupação que você escolhe na abertura e define o que você pode faturar e quais impostos entram no DAS."
  - q: "Quantos CNAEs o MEI pode ter?"
    a: "O MEI pode ter 1 ocupação principal e até 15 ocupações secundárias, todas dentro da lista de ocupações permitidas ao MEI. No total, são até 16 atividades no mesmo CNPJ."
  - q: "Como consultar o CNAE do meu MEI?"
    a: "O seu CNAE aparece no CCMEI (Certificado da Condição de MEI), emitido de graça no Portal do Empreendedor com login gov.br. Ele também consta no Cartão CNPJ, na Receita Federal."
  - q: "O que acontece se eu exercer uma atividade fora do meu CNAE?"
    a: "Se a atividade não estiver no seu cadastro, você não consegue emitir nota corretamente para ela. Se for uma atividade não permitida ao MEI, isso pode levar ao desenquadramento da categoria."
  - q: "Posso mudar o CNAE do MEI depois de aberto?"
    a: "Sim. Dá para incluir, trocar ou remover ocupações pelo Portal do Empreendedor, na opção de alteração de dados, sem custo. O ajuste vale a partir da atualização do cadastro."
  - q: "Como saber qual CNAE escolher na abertura?"
    a: "Descreva em uma frase o que você faz e procure na lista de ocupações do Portal do Empreendedor a que mais se aproxima do seu serviço. No SimplesMEI, a IA também sugere o CNAE pelo WhatsApp."
---
...
Esse é exatamente o ponto em que a IA do SimplesMEI ajuda: em vez de você caçar o termo certo na lista, você descreve o serviço em linguagem normal e ela **traduz isso na ocupação** correta — útil tanto na hora de [abrir o seu MEI](/blog/como-abrir-mei) quanto depois, quando precisa [descrever o serviço batendo com o CNAE na nota](/blog/como-emitir-nota-fiscal-mei).
...
- Acesse o [Portal do Empreendedor](https://www.gov.br/empresas-e-negocios/pt-br/empreendedor) (gov.br) e entre com a sua conta **gov.br**.
