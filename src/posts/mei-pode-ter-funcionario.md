---
title: "MEI pode ter funcionário? Regras, custo e contratação"
date: "2026-06-28"
...
faq:
  - q: "MEI pode ter funcionário?"
    a: "Sim. O MEI pode contratar até 1 empregado, com carteira assinada. O salário tem de ser o piso da categoria ou, na falta dele, o salário mínimo. Contratar um segundo funcionário causa o desenquadramento do MEI."
  - q: "Quanto custa para o MEI ter um funcionário?"
    a: "Além do salário, o MEI recolhe os encargos do empregador: cerca de 8% de FGTS e 3% de INSS patronal sobre o salário, somando aproximadamente 11%. Com as provisões de férias com 1/3 e 13º, o custo total mensal fica maior."
  - q: "Quantos funcionários o MEI pode ter?"
    a: "Apenas 1 empregado. É o limite legal do MEI. Se o negócio precisa de uma segunda pessoa com carteira assinada, é hora de migrar para Microempresa (ME), porque o segundo funcionário desenquadra o MEI."
  - q: "Quais as obrigações do MEI com um funcionário?"
    a: "O MEI com empregado precisa registrar a admissão no eSocial, fazer a folha de pagamento mensal, recolher FGTS e INSS, e garantir férias com 1/3, 13º salário e demais direitos. Essa folha é recolhida à parte, separada do DAS."
  - q: "Como o MEI contrata um funcionário?"
    a: "O MEI faz o registro pelo eSocial (módulo simplificado no gov.br/esocial): cadastra a empresa, registra a admissão do empregado antes do primeiro dia de trabalho, assina a carteira e passa a emitir a guia mensal de FGTS e INSS pelo próprio sistema."
  - q: "A folha do funcionário entra no DAS do MEI?"
    a: "Não. O DAS do MEI segue sendo o valor fixo mensal (INSS sobre o salário mínimo mais ICMS ou ISS). Os encargos do empregado (FGTS e INSS) são uma cobrança separada, recolhida todo mês pelo eSocial, fora do DAS."
---
...
| Item | Quem arca | Percentual sobre o salário | Tipo |
| --- | --- | --- | --- |
| FGTS | Empregador (MEI) | 8% | Encargo recolhido todo mês |
| INSS patronal | Empregador (MEI) | 3% | Encargo recolhido todo mês |
| **Encargos recolhidos** | **MEI** | **~11% (FGTS + INSS)** | **Soma mensal** |
| Provisão de férias + 1/3 | Empregador (MEI) | ~11% | Reserva mensal |
| Provisão de 13º salário | Empregador (MEI) | ~8,3% | Reserva mensal |
| INSS do empregado | Descontado do empregado | faixa progressiva | Você recolhe, não é seu custo |
...
Somando salário + encargos recolhidos (~11%) + provisões, o custo real de um funcionário costuma ficar **bem acima** do salário "de carteira". Faça a conta cheia antes de contratar — e cruze com [o teto do MEI](/blog/limite-do-mei) de R$ 81.000 ao ano, porque a folha sai do seu faturamento.
...
Essa folha **não entra no DAS**. O DAS do MEI segue sendo o valor fixo de sempre (INSS de 5% do salário mínimo + ICMS/ISS); os encargos do funcionário são uma cobrança à parte, mensal, via eSocial. Para a visão completa do que você precisa cumprir como MEI, veja [as obrigações do MEI](/blog/obrigacoes-do-mei).
...
1. **Cadastre a empresa no eSocial.** Acesse [gov.br/esocial](https://www.gov.br/esocial) com a conta gov.br, no módulo do empregador, e complete os dados cadastrais do seu MEI.
...
Se o negócio cresceu a ponto de precisar de duas pessoas, isso costuma ser um bom sinal: é hora de conversar com um contador sobre a transição para ME. Entenda os gatilhos completos em [o que desenquadra o MEI](/blog/desenquadramento-do-mei).
...
Veja também: [as obrigações do MEI](/blog/obrigacoes-do-mei), [o que desenquadra o MEI](/blog/desenquadramento-do-mei), [o teto do MEI](/blog/limite-do-mei) e [como abrir o MEI](/blog/como-abrir-mei).