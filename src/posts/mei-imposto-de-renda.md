---
title: "MEI e Imposto de Renda: DASN x IRPF, o que declarar"
date: "2026-06-27"
...
faq:
  - q: "MEI precisa declarar Imposto de Renda?"
    a: "São duas declarações diferentes. Como empresa, o MEI sempre entrega a DASN-SIMEI, uma vez por ano, até 31 de maio. Como pessoa física, só declara o IRPF se cair nas regras gerais da Receita, como renda tributável acima do limite anual."
  - q: "Qual a diferença entre DASN-SIMEI e IRPF?"
    a: "A DASN-SIMEI é a declaração da empresa (CNPJ): informa o faturamento bruto do ano anterior, é gratuita e obrigatória pra todo MEI. O IRPF é da pessoa física (CPF) e só é obrigatório se você se enquadrar nas regras gerais da Receita Federal."
  - q: "Quando o MEI é obrigado a declarar o IRPF?"
    a: "Quando, como pessoa física, você se enquadra em alguma regra geral da Receita: rendimentos tributáveis acima do limite anual, ganho de capital, posse de bens acima de certo valor, entre outras. Confira os critérios do ano no site da Receita Federal."
  - q: "O lucro do MEI é isento de Imposto de Renda?"
    a: "A parcela de lucro distribuída ao dono do MEI pode ser isenta de IRPF até um limite definido por uma presunção sobre o faturamento, que varia conforme a atividade. O que passar desse limite isento é rendimento tributável e precisa ser declarado."
...
O imposto mensal que a DASN consolida é o assunto do guia [o DAS mensal](/blog/das-do-mei), e o panorama completo está em [as obrigações do MEI](/blog/obrigacoes-do-mei).
...
Em resumo: pergunte "eu, como pessoa física, bato em alguma dessas regras?". Se a resposta for não, você provavelmente só entrega a **DASN** e está em dia. Vale também olhar o conjunto de [obrigações do MEI](/blog/obrigacoes-do-mei) pra não deixar nada de fora.
...
Pra ir mais fundo nos irmãos deste tema, veja [a declaração anual (DASN-SIMEI)](/blog/declaracao-anual-mei) passo a passo, entenda [o DAS mensal](/blog/das-do-mei) que você paga todo mês e veja o panorama de [as obrigações do MEI](/blog/obrigacoes-do-mei) — a lista completa do que mantém o seu CNPJ em dia.
