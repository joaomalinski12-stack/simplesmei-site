---
title: "NFS-e Nacional para o MEI: o que muda em 2026 e como emitir"
date: "2026-06-19"
...
faq:
  - q: "O que é a NFS-e Nacional?"
    a: "É o padrão único nacional da Nota Fiscal de Serviço eletrônica, com um layout só para o Brasil inteiro. Você emite pelo Emissor Nacional, em gov.br/nfse, com login gov.br e de graça."
  ...
  - q: "Como emitir NFS-e pelo Emissor Nacional?"
    a: "Acesse gov.br/nfse, faça login com a conta gov.br, toque em emitir NFS-e, informe o tomador, o serviço e o valor, confirme e baixe o PDF (DANFSE) para enviar ao cliente."
  - q: "Dá para emitir a NFS-e pelo WhatsApp?"
    a: "Pelos canais oficiais não. O SimplesMEI faz a emissão por você: você manda uma frase no WhatsApp e a IA emite a NFS-e, projeta o impacto no teto e devolve número e PDF na conversa."
---
...
Em resumo: a **NFS-e Nacional** é o *padrão* (o formato da nota) e o **Emissor Nacional** é o *lugar* onde você emite. Se você quer entender antes o conceito da nota em si, vale ler [o que é a NFS-e do MEI](/blog/nota-fiscal-eletronica-mei).
...
- **Login gov.br, sem certificado pago na maioria dos casos.** No Emissor Nacional o MEI costuma emitir **só com a conta gov.br**, sem precisar comprar um certificado digital A1. Se essa é a sua trava, vale ler antes [se você precisa de certificado digital](/blog/certificado-digital-mei).
...
Revise tudo, **confirme** a emissão e baixe o **PDF da nota (o DANFSE)** para enviar ao cliente. Pronto: a NFS-e está emitida no padrão nacional, com número e tudo. Se quiser o passo a passo completo da emissão tradicional, veja [como emitir nota fiscal como MEI](/blog/como-emitir-nota-fiscal-mei).
...
E não para na nota avulsa: se você fatura o mesmo valor para o mesmo cliente todo mês, dá para [deixar a emissão recorrente no automático](/blog/nota-fiscal-recorrente-mei) — você configura uma vez e a nota fixa volta a sair no ciclo.
